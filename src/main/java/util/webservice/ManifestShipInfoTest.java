...
public class ManifestShipInfoTest {
    ...
    public static void main(String[] args) {
        ...
        ArrayOfShipInfo shipInfo = interfaceSoap.manifestShipInfo("OOCL JAPAN","010W", "","CNYTN","DFSU1119317");
        ...
        System.out.println(shipInfo.getShipInfo().get(0).getDataPlatform());
        ShipInfo shipInfo1 = shipInfo.getShipInfo().get(0);

//        ArrayOfContaInfo arrayOfContaInfo = interfaceSoap.containerInfo("OOCU7412063","SCT");
